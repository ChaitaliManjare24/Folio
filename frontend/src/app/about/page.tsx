        ...
        <div className="max-w-[var(--max-width)] mx-auto px-[var(--space-6)] lg:px-[var(--space-12)]">
          <div className="grid grid-cols-12 gap-x-[var(--space-8)] gap-y-[var(--space-8)]">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h1 className="font-[family-name:var(--font-display)] text-[var(--text-2xl)] md:text-[var(--text-3xl)] font-bold mb-[var(--space-8)]" style={{ letterSpacing: "-0.02em" }}>
                {cfg.authorName}
              </h1>
              ...
              {experience.length > 0 && (
                <>
                  <h2 className="font-[family-name:var(--font-display)] text-[var(--text-lg)] font-bold mt-[var(--space-12)] mb-[var(--space-6)]" style={{ color: "var(--color-text)" }}>Experience</h2>
                  <div className="flex flex-col gap-[var(--space-6)]">
                    {experience.map((exp) => (
                      <div key={exp.id} className="grid grid-cols-[auto_1fr] gap-[var(--space-4)] items-start">
                        ...
                        />
                        <div>
                          <h3 className="font-[family-name:var(--font-display)] text-[var(--text-base)] font-semibold" style={{ color: "var(--color-text)" }}>{exp.role}</h3>
              ...
              {experienceError && (
                <div className="mt-[var(--space-12)]">
                  <h2 className="font-[family-name:var(--font-display)] text-[var(--text-lg)] font-bold mb-[var(--space-3)]" style={{ color: "var(--color-text)" }}>
                    Experience
                  </h2>
            ...
            <div className="col-span-12 lg:col-span-5">
              {skillGroups.length > 0 && (
                <div className="p-[var(--space-6)] lg:p-[var(--space-8)]" style={{ background: "var(--color-bg-elevated)", border: "1px solid var(--color-border)", borderRadius: "var(--radius-xl)" }}>
                  <h2 className="font-[family-name:var(--font-display)] text-[var(--text-base)] font-bold mb-[var(--space-6)]" style={{ color: "var(--color-text)" }}>Skills & Tools</h2>
                  <div className="flex flex-col gap-[var(--space-5)]">
                    {skillGroups.map((group) => (
                      <div key={group.category}>
                        <h3 className="font-[family-name:var(--font-display)] text-[var(--text-xs)] font-bold uppercase tracking-wider mb-[var(--space-2)]" style={{ color: "var(--color-accent)" }}>
                          {group.category}
                        </h3>
              ...
              <div className="mt-[var(--space-6)] p-[var(--space-6)]" style={{ background: "var(--color-bg-elevated)", border: "1px solid var(--color-border)", borderRadius: "var(--radius-xl)" }}>
                <h2 className="font-[family-name:var(--font-display)] text-[var(--text-base)] font-bold mb-[var(--space-4)]" style={{ color: "var(--color-text)" }}>Connect</h2>
