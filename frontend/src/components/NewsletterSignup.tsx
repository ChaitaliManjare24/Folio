  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-[var(--space-2)]">
      ...
      <button
        ...
        className="font-[family-name:var(--font-body)] text-[var(--text-sm)] font-medium px-5 py-2.5 transition-all hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
